    ...
    <div x-data="{ openAdd: false }">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow">
                ...
                <h5 class="text-lg font-semibold text-gray-800 mb-2">Laporan</h5>
                <p class="text-gray-600 text-sm">Pantau statistik dan laporan peminjaman alat.</p>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow">
                ...
                <h5 class="text-lg font-semibold text-gray-800 mb-2">Pengaturan</h5>
                <p class="text-gray-600 text-sm">Atur konfigurasi sistem sesuai kebutuhan Anda.</p>
            </div>
        </div>
