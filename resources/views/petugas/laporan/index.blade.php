<x-petugas-layout>
    ...
    <x-slot name="header">
        <h2 class="text-xl font-semibold leading-tight text-gray-800">Laporan Peminjaman</h2>
    </x-slot>
                ...
                <div class="overflow-hidden rounded-lg bg-white shadow">
                    <div class="p-5 flex items-center">
                        ...
                        <div class="ml-5">
                            ...
                            <p class="text-2xl font-bold text-gray-900">{{ $stats['dikembalikan'] }}</p>
                        </div>
                    </div>
                </div>
                <div class="overflow-hidden rounded-lg bg-white shadow">
                    <div class="p-5 flex items-center">
                        ...
                        <div class="ml-5">
                            ...
                            <p class="text-2xl font-bold text-gray-900">{{ $stats['dipinjam'] }}</p>
                        </div>
                    </div>
                </div>
                <div class="overflow-hidden rounded-lg bg-white shadow">
                    <div class="p-5 flex items-center">
                        ...
                        <div class="ml-5">
                            ...
                            <p class="text-xl font-bold text-gray-900">Rp {{ number_format($stats['total_denda'], 0, ',', '.') }}</p>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="divide-y divide-gray-200 bg-white">
                                @forelse($alatStats as $index => $stat)
                                    <tr>
                                        <td class="whitespace-nowrap px-6 py-4 text-sm text-gray-900">{{ $loop->iteration }}</td>
                                        <td class="px-6 py-4 text-sm font-medium text-gray-900">
                                            {{ optional($stat['alat'])->nama_alat ?? optional($stat['alat'])->nama ?? 'N/A' }}
                                        </td>
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="divide-y divide-gray-200 bg-white">
                                @forelse($userStats as $stat)
                                    <tr>
                                        <td class="whitespace-nowrap px-6 py-4 text-sm text-gray-900">{{ $loop->iteration }}</td>
                                        <td class="px-6 py-4 text-sm font-medium text-gray-900">{{ optional($stat['user'])->name }}</td>
                                        <td class="px-6 py-4 text-sm text-gray-500">{{ optional($stat['user'])->email }}</td>
                                        <td class="whitespace-nowrap px-6 py-4 text-sm text-gray-900">{{ $stat['total'] }}</td>
                            ...
                            <tbody class="divide-y divide-gray-200 bg-white">
                                @forelse($peminjaman as $item)
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        {{-- ✅ DIPERBAIKI: akses alat lewat items --}}
                                        ...
                                        {{-- ✅ DIPERBAIKI: total unit dari items --}}
                                        ...
                                        <td class="whitespace-nowrap px-6 py-4">
                                            @switch($item->status)
                                                ...
                                                @case('ditolak')
                                                    ...
                                                    @break
                                                @default
                                                    <span class="inline-flex rounded-full bg-gray-100 px-2 py-1 text-xs font-semibold text-gray-800">{{ ucfirst($item->status) }}</span>
                                            @endswitch
                                        </td>
                                    </tr>
                                @empty
